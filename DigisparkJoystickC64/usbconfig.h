...
#define  USB_CFG_VENDOR_ID       0x59, 0x1c /* = 0x1c59 = 7257 = C64 */
/* USB vendor ID for the device, low byte first. If you have registered your
 * own Vendor ID, define it here. Otherwise you may use one of obdev's free
 * shared VID/PID pairs. Be sure to read USB-IDs-for-free.txt for rules!
 * *** IMPORTANT NOTE ***
 * This defines the VID/PID pair for C64 Joystick
 */
#define  USB_CFG_DEVICE_ID       0x23, 0x00 /* = 0x0023 = 35 = C64*/
 ...
 * This defines the VID/PID pair for C64 Joystick
 */
#define USB_CFG_DEVICE_VERSION  0x21, 0x00
/* Version number of the device: Minor number first, then major number.
 */
#define USB_CFG_VENDOR_NAME     ' ','T','H','E','C','6','4',' ','J','o','y','s','t','i','c','k',' '
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     ' ','T','H','E','C','6','4',' ','J','o','y','s','t','i','c','k',' '
 ...
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    90
